...
assert_eq "https://github.com/cyphar/filepath-securejoin" \
    "$(normalize_repo_url 'https://github.com/cyphar/filepath-securejoin.git')" "strip .git"
assert_eq "https://github.com/foo/bar" \
    "$(normalize_repo_url 'https://github.com/foo/bar/')" "strip trailing slash"

assert_eq "capability" \
    "$(derived_subdir github.com/moby/sys/capability github.com/moby/sys)" \
    "subdir from prefix"
assert_eq "" "$(derived_subdir github.com/sirupsen/logrus github.com/sirupsen/logrus)" "root module"

assert_eq "https://github.com/sirupsen/logrus/blob/v1.10.1/LICENSE" \
    "$(blob_url https://github.com/sirupsen/logrus v1.10.1 LICENSE)" "github blob template"
